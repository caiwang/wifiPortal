...
public class DiffCalendar extends GregorianCalendar {  
    ...
    /**
     * Numeric of milliseconds per hour, except when a leap second is inserted.
     */
    public static final long MILLISECS_PER_HOUR   = 60*MILLISECS_PER_MINUTE;
    
    /**
     * Numeric of leap seconds per day expect on 
     ...
     */
    public DiffCalendar( long millisecondTime ) {
        super();
     ...
     */
    public DiffCalendar( int y, int m, int d ) {
        super( y, m, d );
    }
     ...
     */
    public DiffCalendar( int y, int m, int d, int h, int min, int s ) {
        super( y, m, d, h, min, s );
    }
